...
/*
 ...
 3、SDWebImageDownloader实例方法- (id)downloadImageWithURL:(NSURL *)url options:(SDWebImageDownloaderOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageDownloaderCompletedBlock)completedBlock调用SDWebImageDownloaderOperation类的initWithRequest方法生成对象operation，并加入到downloadQueue操作队列中
